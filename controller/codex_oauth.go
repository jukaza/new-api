...
func completeCodexOAuthWithChannelID(c *gin.Context, channelID int) {
	...
	if err != nil {
		...
		c.JSON(http.StatusOK, gin.H{"success": false, "message": "Phân tích thông tin ủy quyền thất bại, vui lòng kiểm tra định dạng đầu vào"})
		return
	}
	...
	if err != nil {
		...
		c.JSON(http.StatusOK, gin.H{"success": false, "message": "Đổi mã ủy quyền thất bại, vui lòng thử lại"})
		return
	}
