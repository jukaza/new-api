...
func GetCodexChannelUsage(c *gin.Context) {
	...
	if err != nil {
		...
		c.JSON(http.StatusOK, gin.H{"success": false, "message": "Giải mã chứng chỉ thất bại, vui lòng kiểm tra cấu hình kênh"})
		return
	}
	...
	if err != nil {
		...
		c.JSON(http.StatusOK, gin.H{"success": false, "message": "Lấy thông tin dung lượng sử dụng thất bại, vui lòng thử lại sau"})
		return
	}
