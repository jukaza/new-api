...
const (
	...
	officialRatioPresetName     = "Cấu hình tỷ lệ chính thức"
	officialRatioPresetBaseURL  = "https://basellm.github.io"
	modelsDevPresetID           = -101
	modelsDevPresetName         = "Cấu hình giá models.dev"
...
func FetchUpstreamRatios(c *gin.Context) {
	...
	if len(req.Upstreams) > 0 {
		...
		if err != nil {
			...
			c.JSON(http.StatusInternalServerError, gin.H{"success": false, "message": "Truy vấn kênh thất bại"})
			return
		}
