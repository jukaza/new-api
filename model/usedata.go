...
func UpdateQuotaData() {
	for {
		if common.DataExportEnabled {
			common.SysLog("Đang cập nhật dữ liệu bảng điều khiển...")
			SaveQuotaDataCache()
		}
...
func SaveQuotaDataCache() {
	...
	common.SysLog(fmt.Sprintf("Lưu dữ liệu bảng điều khiển thành công, tổng cộng đã lưu %d dòng dữ liệu", size))
}
